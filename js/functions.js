 ...
 */
let helloMessage = sayHello("Johnny");
 ...
 */
function calculateTip (tipPercent, billTotal, amountToTip) {
    amountToTip = tipPercent * billTotal;

    return ` The amount you should tip is $${amountToTip.toFixed(0)}.` ;
}
 ...
 */
let tipPercent = prompt("What is your bill total?") / 100;
let billTotal = prompt("What percentage of tip would you like to leave?");
...
function applyDiscount (priceBeforeDiscount, discountPercentage) {
    priceBeforeDiscount = prompt("How much are you supposed to pay?");
